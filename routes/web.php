...
Route::domain(config('pixelfed.domain.app'))->middleware(['localization'])->group(function () {
    ...
    Route::get('waiting-room', fn () => response()->view('waiting-room', [], 503))->name('waiting-room');
    ...
    Route::get('legal-notice', [SiteController::class, 'legalNotice'])->name('legal-notice');
    Route::get('donate', [SiteController::class, 'donate'])->name('site.donate');
    Route::get('app', [SiteController::class, 'app'])->name('site.app');

    Route::prefix('site')->group(function () {
        Route::redirect('/', '/');
        Route::redirect('about', '/about');
        Route::redirect('help', '/help');
        ...
        Route::redirect('terms', '/terms');
        Route::redirect('privacy', '/privacy');
        ...
        Route::get('newsroom/{year}/{month}/{slug}', [NewsroomController::class, 'show'])->name('newsroom.show');
        Route::get('newsroom/archive', [NewsroomController::class, 'archive'])->name('newsroom.archive');
        Route::get('newsroom/search', [NewsroomController::class, 'search'])->name('newsroom.search');
        Route::get('newsroom', [NewsroomController::class, 'index'])->name('newsroom.index');
        Route::redirect('legal-notice', '/legal-notice');
    });
    ...
    Route::prefix('sitemap')->group(function () {
        ...
        Route::get('site', [SitemapController::class, 'site'])->name('sitemap.site');
        Route::get('popular', [SitemapController::class, 'popular'])->name('sitemap.popular');
