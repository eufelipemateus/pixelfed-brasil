...
Route::prefix('api')->group(function () use ($middleware) {
    ...
    Route::prefix('v1')->group(function () use ($middleware) {
        ...
        Route::post('notifications/{id}/dismiss', [ApiV1Controller::class, 'accountNotificationsDismiss'])->middleware($middleware);
        Route::post('notifications/{id}/mark_as_unread', [ApiV1Controller::class, 'accountNotificationsMarkAsUnread'])->middleware($middleware);
        Route::post('notifications/clear', [ApiV1Controller::class, 'accountNotificationsDismissAll'])->middleware($middleware);
        Route::get('notifications/unread_count', [ApiV1Controller::class, 'accountNotificationsUnreadCount'])->middleware($middleware);
    ...
    Route::prefix('v1.1')->group(function () use ($middleware) {
        ...
        Route::prefix('push')->group(function () use ($middleware) {
