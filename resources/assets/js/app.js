...
window.App.util = {
	...
	format: {
		...
		timeAgo: (function(ts) {
            ...
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'year');
            }
            interval = Math.floor(seconds / 2592000);
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'month');
            }
            interval = Math.floor(seconds / 604800);
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'week');
            }
            interval = Math.floor(seconds / 86400);
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'day');
            }
            interval = Math.floor(seconds / 3600);
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'hour');
            }
            interval = Math.floor(seconds / 60);
            if (interval >= 1) {
                return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-interval, 'minute');
            }
            return new Intl.RelativeTimeFormat(locale, { numeric: 'auto', style: 'short' }).format(-seconds, 'second');
		}),
