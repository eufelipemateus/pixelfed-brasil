        ...
        <section class="page-wrapper">
            ...
            <div class="container container-compact">
                <div class="card bg-bluegray-900" style="border-radius: 10px;">
                    <div class="card-header bg-bluegray-800 nav-menu"
                        ...
                        <ul class="nav justify-content-around">
                            ...
                            <li v-if="config.show_directory" class="nav-item">
                                <router-link to="/web/directory" class="nav-link">{{ $t('site.directory')
                                }}</router-link>
                            </li>
                    ...
                    <div class="card-img-top p-2">
                        <img :src="config.about.banner_image" class="img-fluid rounded"
                            style="width: 100%;max-height: 200px;object-fit: cover;" alt="Server banner image"
                            height="200" onerror="this.src='/storage/headers/default.jpg';this.onerror=null;">
                    </div>
                        ...
                        <div class="list-group">
                            <div v-if="config.contact.account" class="list-group-item bg-transparent">
                                ...
                                <a :href="config.contact.account.url" class="admin-card" target="_blank">
                                    <div class="d-flex">
                                        <img :src="config.contact.account.avatar" width="45" height="45" class="avatar"
                            ...
                            <div class="card bg-bluegray-700">
                                <div class="card-header bg-bluegray-800" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block" type="button" data-toggle="collapse"
                                            ...
                                            <i class="far"
                                                :class="[accordionTab === 0 ? 'fa-chevron-left text-primary' : 'fa-chevron-down']"></i>
                                        </button>
                                    </h2>
                                </div>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body about-text">
                                        <p>Comunidade voltada para usuários brasileiros que buscam privacidade e
                                            federação.</p>
                                ...
                                <div class="card-header bg-bluegray-800" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block text-left collapsed" type="button"
                                            ...
                                            aria-controls="collapseTwo" @click="toggleAccordion(1)">
                                            <span class="text-white h5">
                                                <i class="far fa-list mr-2 text-muted"></i>
                                                {{ $t('site.serverRules') }}
                                            </span>
                                            <i class="far"
                                                :class="[accordionTab === 1 ? 'fa-chevron-left text-primary' : 'fa-chevron-down']"></i>
                                        </button>
                                    </h2>
                                </div>
