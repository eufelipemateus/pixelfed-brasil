...
@else
<p class="lead text-center mt-4"><span class="opacity-5">The admins have not specified any community rules, however we suggest youreview the</span> <a href="/terms" target="_blank" class="text-white font-weight-bold">Terms of Use</a> <span class="opacity-5">and</span> <a href="/privacy" target="_blank" class="text-white font-weight-bold">Privacy Policy</a>.</p>
@endif
