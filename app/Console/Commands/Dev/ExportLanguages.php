...
class ExportLanguages extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($langs as $lang) {
            ...
            // Some partially translated locales deliberately have no web.php.
            // Laravel returns the key name in that case; export an empty object
            // so the SPA falls back to English rather than throwing a TypeError.
            if (! is_array($strings)) {
                $strings = [];
            }
