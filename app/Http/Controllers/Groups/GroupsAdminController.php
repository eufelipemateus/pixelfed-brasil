...
class GroupsAdminController extends Controller
{
    ...
    public function getReportList(Request $request, $id): JsonResponse
    {
        ...
        $list = GroupReport::selectRaw('MAX(id) as id, MAX(profile_id) as profile_id, MAX(item_type) as item_type, item_id, MAX(type) as type, MAX(created_at) as created_at, COUNT(*) as total')
