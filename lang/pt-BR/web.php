...
return [
	...
	'common' => [
		...
		'endOfFeed' => 'Você atingiu o final do feed.',
	...
	'site' => [
		...
		'beFirstToPopulate' => 'Seja o primeiro a popular nosso diretório!',
		'contact' => 'Contato',
		'directory' => 'Diretório',
		'discoverAccounts' => 'Descubra contas e pessoas',
		'explore' => 'Explorar',
		'exploreTrending' => 'Explore publicações em tendência',
		'federation' => 'Federação',
		'followers' => 'Seguidores',
		'following' => 'Seguindo',
		'intro' => 'Conheça os fotógrafos e criadores que fazem parte da nossa rede brasileira.',
		'locatingCreators' => 'Localizando criadores...',
		'login' => 'Entrar',
		'managedBy' => 'Administrado por',
		'maxCaptionLength' => 'de cada vez com um comprimento máximo de legenda de {maxCaptionLength} caracteres.',
		'maxFileSize' => '* - O tamanho máximo do arquivo é {maxPhotoSize}',
		'mobileAppSuport' => 'Suporte para aplicativos móveis',
		'noData' => 'Nada para mostrar ainda! Volte mais tarde.',
		'noProfileFound' => 'Nenhum perfil encontrado',
		'nothingNew' => 'Nada novo por aqui hoje. Que tal ser o primeiro?',
		'posts' => 'Publicações',
		'serverRules' => 'Regras do servidor',
		'sharePhotos' => 'Você pode compartilhar até {albumLimit} fotos*',
		'shareVideo' => 'ou 1 vídeo*',
		'signup' => 'Registrar',
		'softwareDescription' => 'Rede social descentralizada de compartilhamento de fotos mantida por <a href="https://pixelfed.org" target="_blank">Pixelfed</a>',
		'subtitle' => 'Descubra as tendências da fotografia independente no Brasil.',
		'supportedFeatures' => 'Funcionalidades suportadas',
		'syncingFeed' => 'Sincronizando feed...',
		'totalUsers' => 'Total de usuários',
		'trendingSubtitle' => 'As publicações mais relevantes do Pixelfed Brasil no momento.',
	...
	'notifications' => [
		...
		'likes' => 'Curtidas',
		'likesDescription' => 'Contas que curtiram suas publicações',
		'followers' => 'Seguidores',
		'followersDescription' => 'Contas que seguiram você',
		'reblogs' => 'Reblogs',
		'reblogsDescription' => 'Contas que compartilharam ou reblogaram suas publicações',
		'dms' => 'DMs',
		'dmsDescription' => 'Mensagens diretas que você troca com outras contas',
		'accept' => 'Aceitar',
		'reject' => 'Rejeitar',
		'markAllRead' => 'Confirmar que deseja marcar todas como lidas?',
	],
	...
	'story' => [
		...
		'noViewers' => 'Ainda sem visualizadores',
	...
	'timeline' => [
		...
		'reblog' => [
			'introducing' => 'Apresentando reblogs nos feeds',
			'description' => 'Veja reblogs de contas que você segue no seu feed inicial!',
			'disableInfo' => 'Você pode desativar reblogs nos feeds na página de configurações da timeline.',
			'showReblogs' => 'Mostrar reblogs no feed inicial',
		],
